...
class VariableThresholds:
    ...
    pressure_drop_critical: int = -25   # > 2.5 hPa drop (hourly data)
    pressure_drop_warning: int = -15    # > 1.5 hPa drop
    ...
    def analyze(
        ...
        if "pressure" in data and data["pressure"]:
            ...
            if len(pressure) > 1:
                ...
                elif max_drop < self.thresholds.pressure_drop_warning:
                    contributions["pressure"] += 10
                    signals.append("PRESSURE_DROP")
